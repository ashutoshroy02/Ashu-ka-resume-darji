...
- **India Locations (Priority Order):**
  - Gurugram: **5.0/5** (Home city)
  - Delhi: **4.8/5**
  - Noida: **4.6/5**
  - Pune: **4.4/5**
  - Bangalore: **4.2/5**
  ...
  - Raipur: **3.8/5**
  - Other India: **3.7/5**
- **Global Remote:** **4.5/5** (High preference)
- **Outside India Onsite/Hybrid:** **3.0/5** (Low preference, but DO NOT auto-reject. Let the user decide).
- **Remote Dimension for Hybrid outside country:** score **2.0** (Low) unless JD says Remote is an option.
